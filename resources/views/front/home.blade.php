...
<div class="container-fluid py-5 mb-5 hero-header"
    style="background-image: url('front/img/home2.jpg'); background-size: cover; background-position: center;">
...
<div class="container-fluid pt-5">
    <div class="container">
        <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
                    ...
                    <div class="modal-content rounded-0">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="ratio ratio-16x9">
                                <!-- Add an ID to the iframe for easy access with JavaScript -->
                                <iframe id="videoIframe" class="embed-responsive-item" allowfullscreen
            ...
            <!-- Add JavaScript to update the iframe src when the button is clicked -->
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    var videoModal = new bootstrap.Modal(document.getElementById('videoModal'));
                    var videoIframe = document.getElementById('videoIframe');

                    // Update the src attribute when the modal is shown
                    videoModal._element.addEventListener('shown.bs.modal', function () {
                        // Replace 'VIDEO_URL' with the actual URL of your video
                        videoIframe.src = "{{ asset('front/img/video.mp4') }}";
                    });
        ...
        <div class="row gx-5">
            <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100" src="{{asset('front/img/about1.jpg')}}"
                        style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-6 pb-5">
                <h4 class="mb-4">What are we ?.</h4>
                <p class="mb-5">Ecocraft is a pioneering company committed to providing sustainable and eco-friendly
                    products that align with the growing global movement towards environmental responsibility.
                    Established with a vision to make a positive impact on the planet, Ecocraft has become a leading
                    name in the industry, offering a diverse range of products designed to promote a greener and more
                ...
                <div class="row g-5">
                    ...
                    <div class="col-sm-6">
                        ...
                        <p class="mb-0">Ecocraft is proud to have received prestigious awards for our commitment to
                            sustainability, innovation, and excellence in the eco-friendly product industry.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="team-item text-center">
                    <div class="bg-dark border-inner text-center p-4">
                        ...
                        <div class="position-relative overflow-hidden">
                            <img class="rounded" src="front/img/img-1.jpg" alt="Art"
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item text-center">
                    <div class="bg-dark border-inner text-center p-4">
                        ...
                        <div class="position-relative overflow-hidden">
                            <img class="rounded" src="front/img/img-3.jpg" alt="Tea"
                                style="width: 400px; height: 250px;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item text-center">
                    <div class="bg-dark border-inner text-center p-4">
                        ...
                        <div class="position-relative overflow-hidden">
                            <img class="rounded" src="front/img/img-2.jpg" alt="SKIN CARE"
                                style="width: 400px; height: 250px;">
