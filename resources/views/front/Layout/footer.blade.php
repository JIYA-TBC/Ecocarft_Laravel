            ...
            <div class="col-lg-4 col-md-6 mb-lg-n5">
                <div
                    ...
                    <a href="/" class="navbar-brand">
                        <h1 class="m-0 text-uppercase text-white"><i class="fa fa-leaf fs-1 text-dark me-3"></i>ECOCRAFT
                        </h1>
                    </a>
                    <p class="mt-3">"At Ecocraft, we go beyond simply offering eco-friendly products. We are on a
                        mission to redefine well-being by providing sustainable, health-conscious alternatives that
                        empower individuals to make environmentally responsible choices without compromising on quality
                        or style."</p>
                </div>
            </div>
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="{{route('home.about')}}"><i
                                    class="bi bi-arrow-right text-primary me-2"></i>About Us</a>
                            <!-- <a class="text-secondary mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Our Services</a>
                                <a class="text-secondary mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Meet The Team</a>
                                <a class="text-secondary mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Latest Blog</a> -->
                            <a class="text-secondary" href="{{route('home.contact')}}"><i
